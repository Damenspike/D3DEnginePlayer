...
const DEFAULTS = {
	...
	color: 0xffffff,            // NUMBER
	metalness: 0.2,
	roughness: 0.6,
	emissive: 0x000000,         // NUMBER
	emissiveIntensity: 0,
	opacity: 1,
	transparent: false,
	wireframe: false,
	side: 'FrontSide',          // string is fine
	map: '',
	normalMap: '',
	roughnessMap: '',
	metalnessMap: '',
...
// --- color helpers (strictly numeric <-> #rrggbb) ---
 ...
 * Props:
 * - uri: string
 * - onChange(next, prev?)   // live
 * - onSave(prev, next)      // commit
 * - openAsset({ format, field, current })
 */
		...
		<div className="material-editor">
			...
			<div className="material-editor-row">
				...
				<input
					...
					onChange={(e) => patch({ color: inputToNum(e.target.value) })}
					onBlur={(e) => {
			...
			{mat.type !== 'basic' && fileRow('Roughness Map', 'roughnessMap')}
			{mat.type !== 'basic' && fileRow('Metalness Map', 'metalnessMap')}
